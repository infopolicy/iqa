...
#placeholder: tabular representation of data (may need to re-format FY back, edit column names)
#RFCs_and_RFRs_FY |>
#  gt()|>
#  tab_header(
#    title = " Table x: Number of Requests for Correction (RFCs) and Reconsideration (RFRs) by fiscal year"
#  )
