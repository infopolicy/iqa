...
subtitle: "Reporting of Agency Compliance Data (2003-2025)"
...
#### **Figure 2: Number of Requests for Correction (RFCs) and Reconsideration (RFRs) by agency (FY2003-FY2025)**
```{r message = FALSE, warning = FALSE, echo=FALSE, fig.dim = c(8,6)}
...
tab2 |>
  ...
  cols_align("left")|>
  tab_header(
    title = " Table 2: Number of Requests for Correction (RFCs) and Reconsideration (RFRs) by agency (FY2003-FY2025)"
  )
...
#### **Figure 3: Percent of Requests for Correction (RFCs) received by agency (FY2003-FY2025)**
```{r message = FALSE, warning = FALSE, echo=FALSE}
...
tab3 |>
  ...
  cols_align("left")|>
  tab_header(
    title = " Table 3: Percent of Requests for Correction (RFCs) received by agency (FY2003-FY2025)"
  )
...
#### **Figure 4: Final Resolutions of Requests for Correction (FY2003-FY2025)**
...
tab4 |>
  ...
  cols_align("left")|>
  tab_header(
    title = " Table 4: Final Resolutions of Requests for Correction (FY2003-FY2025)"
  )
...
#### **Figure 5: Organizations requesting corrections (FY2019-FY2025)**
...
tab5 |>
  ...
  cols_align("left")|>
  tab_header(
    title = " Table 5: Organizations requesting corrections (FY2019-FY2025)"
  )
...
#### **Figure 6: Types of information subjected to Requests for Correction (FY2019-FY2025)**
```{r message = FALSE, warning = FALSE, echo=FALSE, fig.dim = c(8,6)}
...
tab6 |>
  ...
  cols_align("left")|>
  tab_header(
    title = " Table 6: Types of information subjected to Requests for Correction (FY2019-FY2025)"
  )
...
#### **Figure 8: Number of peer reviews completed  by agency (FY2003-FY2025)**
```{r message = FALSE, warning = FALSE, echo=FALSE, fig.dim = c(8,6)}
...
###### **Figure 8: Number of peer reviews completed  by agency (FY2003-FY2025)** <br> Data presented as a total count of all peer reviews subject to the Peer Review Bulletin. A CSV file of these data is available [here](../data/csvs/FIGURE-8-TABLE.csv){target="_blank"}.
...
#### **Figure 9: Percent of peer reviews completed by agency (FY2003-FY2025)**
```{r message = FALSE, warning = FALSE, echo=FALSE}
#peer_reviews_by_fiscal_year
#HISA_by_fiscal_year
...
######  **Figure 9: Percent of peer reviews completed by agency (FY2003-FY2025)** <br> Data presented as a percent of  all peer reviews subject to the Peer Review Bulletin (ISI+HISA). A CSV file of these data is available [here](../data/csvs/FIGURE-9-TABLE.csv){target="_blank"}.
...
tab9 |>
  ...
  cols_align("left")|>
  tab_header(
    title = " Table 9: Percent of peer reviews completed by agency (FY2003-FY2025)"
  )
