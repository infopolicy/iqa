...
###### **Figure 8: Number of peer reviews completed  by agency (FY2003-FY2024)** <br> Data presented as a total count of all peer reviews subject to the Peer Review Bulletin. A tabular representation of these data is available [here](../data/csvs/FIGURE-8-TABLE.csv){target="_blank"}.
...
######  **Figure 9: Percent of peer reviews completed by agency (FY2003-FY2024)** <br> Data presented as a percent of  all peer reviews subject to the Peer Review Bulletin (ISI+HISA). A tabular representation of these data is available [here](../data/csvs/FIGURE-9-TABLE.csv){target="_blank"}.
