...
>
> Additional details about the methodology used in compiling this report, including information on data extraction data quality can be found in the [support documentation](..README.md){target="_blank"}.
